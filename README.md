...
## Summarizing FitBit Data for BellaBeat
...
dailyActivity_merged.csv, sleepDay_merged.csv, weightLogInfo_merged.csv

#### 2.5 Tool
We are using R for Data Cleaning and Transformation and visualization.
...
Here, we will do our analysis and find out insights.

Below query will tell total activity hours,sedentary hours and specific day of the week
...
-People are more active on Sundays and the trend is slowly decreasing throughout the week.
-There is a positive correlation between calories burned and total steps taken/ total active hours
-The graph between sleep hours and calorie burned also tells also that when people is not sleep for atleast 5 hours the calories burned is decreasing and from 5 hrs to 7hrs it is the maximum and till 10 hrs it is constant and when people is sleeping more than 10 hrs it again starts to fall.
...
-Bellabeat could create some goals for users and then whoever fulfill those goals could get some membership discounts.
...
Bellabeat should create devices that would track sleep more sophisticatedly to provide more insights into sleep health.
